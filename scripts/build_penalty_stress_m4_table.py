...
def main() -> None:
    ...
    patterns = (
        ("FA-SAL (UM)", 1, "penalty_stress_fa_sal_policy_uncertainty_max_lf_scale_1_l_ell_scale_0p001_m4_evalm4_lfestlegacy_axis_quantile_*_rounds150_trials10_results.json"),
        ("FA-SAL (RS)", 0, "penalty_stress_fa_sal_policy_random_safe_lf_scale_1_l_ell_scale_0p001_m4_evalm4_lfestlegacy_axis_quantile_*_rounds150_trials10_results.json"),
        ("FA-SAL (GM)", 0, "penalty_stress_fa_sal_policy_greedy_margin_lf_scale_1_l_ell_scale_0p001_m4_evalm4_lfestlegacy_axis_quantile_*_rounds150_trials10_results.json"),
        ("SAL-NX", 1, "penalty_stress_salnx_alpha_0p01_m4_evalm4_lfestlegacy_axis_quantile_*_rounds150_trials10_results.json"),
        ("Tebbe-ABM", 1, "penalty_stress_tebbe_abm_alpha_0p01_confidence_delta_0p01_m4_evalm4_ucand11_mcprefix0_localref0_lfestlegacy_axis_quantile_*_rounds150_trials10_results.json"),
    )
